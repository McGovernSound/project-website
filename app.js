...
async function fetchProjectData(projectObj) {
    if (projectObj.type === 'webapp') {
        return {
            name: projectObj.displayName || projectObj.id,
            description: projectObj.description || "No description provided.",
            version: "v1.0.0",
            downloadUrl: projectObj.path,
